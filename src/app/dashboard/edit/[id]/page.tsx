...
export default function EditRecipePage() {
    ...
    return (
        <div className="max-w-4xl mx-auto py-8 px-4">
            <h1 className="text-3xl font-bold text-gray-900 mb-8">View & Edit Recipe</h1>
            ...
            <div className="space-y-8">
                ...
                <div className="flex justify-end gap-4 pt-4">
                    <button
                        ...
                        disabled={deleting}
                        className="px-6 py-2.5 bg-red-50 text-red-600 font-medium rounded-lg hover:bg-red-100 transition-colors mr-auto"
                    >
                    ...
                    <button
                        onClick={handleSave}
                        disabled={saving}
                        className="px-6 py-2.5 bg-green-500 text-white font-medium rounded-lg hover:bg-green-600 shadow-lg shadow-green-500/30 transition-all disabled:opacity-50"
                    >
